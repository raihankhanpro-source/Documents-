...
fun ScreenOtherServices(
    ...
    val otherServicesList = services.filter {
        it.category == "OTHER_SERVICES" &&
    ...
    Scaffold(
        ...
        bottomBar = {
            CivilBottomNavigation(
                selectedTab = NavTab.OTHER_SERVICES,
        ...
        LazyVerticalGrid(
            ...
            item(span = { GridItemSpan(2) }) {
                Text(
                    ...
                    modifier = Modifier
                        ...
                        .testTag("other_services_title")
                )
            }

            // Search Bar (matching Screenshot 7)
            item(span = { GridItemSpan(2) }) {
                SearchInputField(
                    query = searchQuery,
            ...
            // Section Header: Preferred Services
            item(span = { GridItemSpan(2) }) {
                Text(
            ...
            items(otherServicesList) { service ->
                ServiceCard(
                    title = service.title,
